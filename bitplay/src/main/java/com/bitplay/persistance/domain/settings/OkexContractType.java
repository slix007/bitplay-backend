...
public enum OkexContractType implements ContractType {
    ...
    BTC_ThisWeek(FuturesContract.ThisWeek, CurrencyPair.BTC_USD, BigDecimal.valueOf(0.1), 1),
    BTC_NextWeek(FuturesContract.NextWeek, CurrencyPair.BTC_USD, BigDecimal.valueOf(0.1), 1),
    BTC_Quarter(FuturesContract.Quarter, CurrencyPair.BTC_USD, BigDecimal.valueOf(0.1), 1),
    BTC_BiQuarter(FuturesContract.BiQuarter, CurrencyPair.BTC_USD, BigDecimal.valueOf(0.1), 1),
    ETH_Swap(FuturesContract.Swap, CurrencyPair.ETH_USD, BigDecimal.valueOf(0.01), 2),
    ETH_ThisWeek(FuturesContract.ThisWeek, CurrencyPair.ETH_USD, BigDecimal.valueOf(0.01), 2),
    ETH_NextWeek(FuturesContract.NextWeek, CurrencyPair.ETH_USD, BigDecimal.valueOf(0.01), 2),
    ETH_Quarter(FuturesContract.Quarter, CurrencyPair.ETH_USD, BigDecimal.valueOf(0.01), 2),
    ETH_BiQuarter(FuturesContract.BiQuarter, CurrencyPair.ETH_USD, BigDecimal.valueOf(0.01), 2),
