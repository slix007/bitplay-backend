...
//    private static final Logger debugLog = LoggerFactory.getLogger("DEBUG_DELTA_AVG");
    ...
    private Pair<Instant, BigDecimal> b_delta_sma = Pair.of(Instant.now(), DeltasCalcService.NONE_VALUE);
    private Pair<Instant, BigDecimal> o_delta_sma = Pair.of(Instant.now(), DeltasCalcService.NONE_VALUE);
