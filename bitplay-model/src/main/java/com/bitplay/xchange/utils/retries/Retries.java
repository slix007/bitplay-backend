...
public class Retries {
   ...
   * exponentially. For examples: @see {@link com.bitplay.xchange.examples.core.utils.RetriesDemo}
   *
   ...
   * @param retryableException An instance of {@link IPredicate} that will be used to check if the exception caught is
