package com.bitplay.xchange.service.trade;
...
import com.bitplay.xchange.service.trade.params.TradeHistoryParamsAll;
...
public interface TradeService extends BaseService {
   ...
   * through the javadoc.
   * <p/>
   * There is also implementation of all the common interfaces, {@link TradeHistoryParamsAll} , that,
  ...
  /**
   * Verify the order against the exchange meta data. Most implementations will require that {@link Exchange#remoteInit()} be called
   * before this method
   */
