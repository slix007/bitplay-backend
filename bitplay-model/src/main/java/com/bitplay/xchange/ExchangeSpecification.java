...
public class ExchangeSpecification {
   ...
   * Dynamic binding
   *
   * @param exchangeClassName The exchange class name (e.g. "com.bitplay.xchange.mtgox.v1.MtGoxExchange")
   */
  ...
  /**
   * Get the override file for generating the {@link ExchangeMetaData} object. By default, the
   * {@link ExchangeMetaData} object is loaded at startup from a json file on the classpath with the same name as the name
  ...
  /**
   * Set the override file for generating the {@link ExchangeMetaData} object. By default, the
   * {@link ExchangeMetaData} object is loaded at startup from a json file on the classpath with the same name as the name
   * of the exchange as defined in {@link ExchangeSpecification}. With this parameter, you can override that file with a file of your choice located
   * outside of the classpath.
   *
