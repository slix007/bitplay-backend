...
public class PlacingBlocksServiceTest {
    ...
    public void getDynamicBlockBitmexInsideFirst() {
        ...
        final DynBlocks dynamicBlockBitmex = placingBlocksService.getDynamicBlockBitmex(bOb, oOb, bBorder, maxBlock);
    ...
    public void getDynamicBlockOkexFirstFull() {
        ...
        final DynBlocks dynamicBlockBitmex = placingBlocksService.getDynamicBlockOkex(bOb, oOb, oBorder, maxBlock);
