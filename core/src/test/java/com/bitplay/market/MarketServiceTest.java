...
public class MarketServiceTest {
    ...
    public void setScaleDown() {
        ...
        final BigDecimal upExact0 = marketService.setScaleDown(BigDecimal.valueOf(7809.5), BitmexContractType.XBTUSD);
        assertEquals(BigDecimal.valueOf(7809.5), upExact0);

        // scale 1, ticksize 0.5
        final BigDecimal upExact = marketService.setScaleDown(BigDecimal.valueOf(7809.02), BitmexContractType.XBTUSD);
        //noinspection BigDecimalMethodWithoutRoundingCalled
        assertEquals(BigDecimal.valueOf(7809.0).setScale(1), upExact);

        final BigDecimal upHalf = marketService.setScaleDown(BigDecimal.valueOf(7809.62), BitmexContractType.XBTUSD);
        assertEquals(BigDecimal.valueOf(7809.5), upHalf);

        final BigDecimal diff = marketService.setScaleDown(BigDecimal.valueOf(0.02), BitmexContractType.XBTUSD);
        //noinspection BigDecimalMethodWithoutRoundingCalled
        assertEquals(BigDecimal.valueOf(0.0).setScale(1), diff);

        final BigDecimal diff1 = marketService.setScaleDown(BigDecimal.valueOf(0.92), BitmexContractType.XBTUSD);
        assertEquals(BigDecimal.valueOf(0.5), diff1);

        final BigDecimal diff2 = marketService.setScaleDown(BigDecimal.valueOf(0.49992), BitmexContractType.XBTUSD);
        //noinspection BigDecimalMethodWithoutRoundingCalled
        assertEquals(BigDecimal.valueOf(0.0).setScale(1), diff2);

        final BigDecimal diff3 = marketService.setScaleDown(BigDecimal.valueOf(0.500001), BitmexContractType.XBTUSD);
        assertEquals(BigDecimal.valueOf(0.5), diff3);

        final BigDecimal diff4 = marketService.setScaleDown(BigDecimal.valueOf(-0.2), BitmexContractType.XBTUSD);
        //noinspection BigDecimalMethodWithoutRoundingCalled
        assertEquals(BigDecimal.valueOf(-0.0).setScale(1), diff4);

        final BigDecimal diff5 = marketService.setScaleDown(BigDecimal.valueOf(-0.07), BitmexContractType.ETHUSD);
        //noinspection BigDecimalMethodWithoutRoundingCalled
        assertEquals(BigDecimal.valueOf(-0.05).setScale(2), diff5);

        final BigDecimal diff6 = marketService.setScaleDown(BigDecimal.valueOf(-0.04), BitmexContractType.ETHUSD);
        //noinspection BigDecimalMethodWithoutRoundingCalled
        assertEquals(BigDecimal.valueOf(-0.00).setScale(2), diff6);

        final BigDecimal diff7 = marketService.setScaleDown(BigDecimal.valueOf(-1.07), BitmexContractType.XBTUSD);
        //noinspection BigDecimalMethodWithoutRoundingCalled
