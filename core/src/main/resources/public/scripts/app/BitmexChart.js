export default Vue.component('line-chart-bitmex', {
    ...
    methods: {
        fetchData() {
            ...
            axios.get('http://' + hostname + ':4031/deltas/B_DELTA?lastHours=' + hoursCount)
                .then(response => {
                    this.loading = false;
            ...
            let bDeltaArray = theData.map(item => item.delta);
