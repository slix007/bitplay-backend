...
public enum ContractMode {
    ...
    MODE3_SET_BU23("M20", "set_bu23", BitmexContractType.XBTM19, OkexContractType.BTC_Quarter),
    MODE_TMP("TMP", "set_tmp", BitmexContractType.XBTH19, OkexContractType.BTC_Quarter),
